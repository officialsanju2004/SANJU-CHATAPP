...
export default function Sidebar({
  ...
  return (
    <aside className="w-full sm:w-80 shrink-0 bg-surface border-r border-surface-border flex flex-col h-full">
      <div className="px-5 py-4 border-b border-surface-border flex items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="font-display font-semibold text-sm text-ember-50 truncate">Ember Chat</p>
      ...
      <div className="flex px-4 pt-3 gap-2">
        ...
        <button
          ...
          className={`relative flex-1 text-xs font-medium py-2 rounded-lg transition-colors ${
            tab === 'add'
              ? 'bg-ember-500 text-void-950 shadow-neon'
              : 'text-ember-50/50 hover:text-ember-50 bg-void border border-surface-border'
          }`}
